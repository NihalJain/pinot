...
public class BasicAuthUtilsTest {
  ...
  public void testExtractBasicAuthPrincipals(ComponentType componentType) {
    UserConfig userConfig = new UserConfig("admin", "password", componentType.name(),
        RoleType.ADMIN.name(), Arrays.asList("table1", "table2"), Arrays.asList("excludeTable1"),
        Arrays.asList(AccessType.READ, AccessType.DELETE));

    List<ZkBasicAuthPrincipal> principals = BasicAuthUtils.extractBasicAuthPrincipals(Collections.singletonList(userConfig));
  ...
  public void testExtractBasicAuthPrincipalsWithEmptyTables(ComponentType componentType) {
    UserConfig userConfig = new UserConfig("admin", "password", componentType.name(),
        RoleType.ADMIN.name(), Collections.emptyList(), Arrays.asList("excludeTable1"),
        Arrays.asList(AccessType.READ, AccessType.DELETE));
  ...
  public void testExtractBasicAuthPrincipalsWithEmptyPermissions(ComponentType componentType) {
    UserConfig userConfig = new UserConfig("admin", "password", componentType.name(),
        RoleType.ADMIN.name(), Arrays.asList("table1", "table2"), Arrays.asList("excludeTable1"), Arrays.asList());
