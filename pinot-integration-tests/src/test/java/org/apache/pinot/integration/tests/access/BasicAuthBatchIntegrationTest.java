 ...
 */
public class BasicAuthBatchIntegrationTest extends AbstractAuthBatchIntegrationTest {
  ...
  protected String getAuthToken() {
    return BasicAuthTestUtils.AUTH_TOKEN;
  }
  ...
  protected Map<String, String> getUserAuthHeader() {
    return BasicAuthTestUtils.AUTH_HEADER_USER;
  }
}
